...
Do not add an undeclared capability, package, native executable, downloaded binary, process invocation, or external host to make a review pass. Change the implementation and declaration together, then submit the normal review evidence.
